...
const CONFIG_OWNER = [
  { id: 'cfg-org', label: 'Organización', sub: 'Configuración del negocio', href: '/configuracion?tab=organizacion', icon: I.config, keywords: ['organizacion', 'negocio', 'empresa', 'configuracion', 'ajustes', 'nombre del negocio', 'logo', 'moneda', 'capital estricto', 'dias sin cobro'] },
