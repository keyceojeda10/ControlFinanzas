...
export const MODOS_INTERES = [
  {
    ...
    descripcion: 'Se aplica el porcentaje sobre el saldo que debe al momento del corte',
  },
  {
    value: 'diario_saldo',
    label: 'Interes diario',
    descripcion: 'Se acumula dia a dia sobre el saldo. Mas preciso pero genera mas interes si el saldo sube rapido',
  },
  {
    value: 'al_corte',
    label: 'Interes al corte',
    descripcion: 'Se aplica el porcentaje sobre todo lo usado en el mes (saldo anterior + desembolsos del periodo)',
  },
]
