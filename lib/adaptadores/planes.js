...
export function loQueDesbloquea(id) {
  ...
  // El cobrador primero: es la razón por la que la gente sube de plan.
  if (c.maxUsuarios > 1) partes.push(`${c.maxUsuarios} personas cobrando`)
  else partes.push('tú solo')
...
/** Todos los planes de la escalera, del más barato al más caro. */
