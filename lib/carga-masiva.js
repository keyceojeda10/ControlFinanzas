    ...
    if (valorCuota > 0 && monto > 0 && dias > 0) {
      ...
      if (totalArchivo < monto * 0.5 || totalArchivo > monto * 3) {
        ...
        /* ⚠ «QUE LO MIRE» SIN DARLE CON QUÉ ERA UN CALLEJÓN (23 sep 2026). El
           prestamista veía el error y ninguna forma de arreglarlo desde aquí. Y el
           archivo casi siempre trae la respuesta: la TASA. Medido en el caso real:
           «$400.000 al 20 %, cuota $12.000, 30 cuotas» — con el 20 % son $480.000,
           o sea 40 cuotas de $12.000, y el saldo que traía el archivo ($12.000)
           deja pagado el 97,5 %, lo mismo que decían sus «cuotas pagadas» (29,25
           de 30). Era la cantidad de cuotas lo que venía mal.
           Se OFRECE, no se aplica: quien confirma es el prestamista, que tiene la
