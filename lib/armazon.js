...
export function resolverArmazon(pathname) {
  ...
  //
  // ESTAS SI SE QUEDAN SIN PASTILLA, y no es lo mismo que las fichas: aquí se
  // entra desde un menú, no desde una lista de trabajo. La pastilla llevaría a
  // los cinco destinos de siempre, que es de donde se acaba de venir.
