...
// Las 6 de navegacion MAS el quinto destino de la pastilla. Sin /mas aqui se
// resuelve como detalle: sale con flecha de volver y sin titulo, y una pantalla
// a la que se llega desde la barra no es el detalle de nada.
const NAVEGACION = [
  '/dashboard',
  '/cobros-hoy',
  '/clientes',
