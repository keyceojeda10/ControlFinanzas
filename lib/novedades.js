    ...
    items: [
      {
        ...
        texto: 'Tus clientes ahora pueden ver sus propios prestamos desde un enlace. Entran con su numero de telefono y un PIN que tu defines. Ven el proximo pago, el historial y el progreso del prestamo. Puedes activar o desactivar el acceso desde el perfil de cada cliente.',
      },
      {
        icon: 'chart',
        titulo: 'Analiticas de negocio',
        texto: 'Nuevo dashboard con metricas clave: ROI, ganancia neta, proyeccion de ingresos y alertas de mora con nombres. Incluye ranking de cobradores y un PDF descargable con todo el resumen.',
      },
      {
        icon: 'dollar',
        titulo: 'Reportes de rentabilidad',
        texto: 'Nuevo reporte que desglosa cuanto es interes y cuanto es capital en tu recaudo. Muestra la utilidad real por mes y el ROI por ruta para que sepas donde rinde mas tu plata.',
      },
      {
        icon: 'pen',
        titulo: 'Campos personalizables en recibos',
        texto: 'Configura que campos aparecen en el comprobante de pago: cedula, telefono, direccion, saldo pendiente y mas. Puedes definir campos por defecto o personalizarlos por cliente.',
      },
      {
        icon: 'dollar',
        titulo: 'Pagos con Wompi',
        texto: 'Nueva opcion de pago para Colombia con Wompi. Tus clientes pueden pagar su suscripcion con PSE, tarjeta o Nequi directamente desde la app.',
      },
      {
        icon: 'document',
        titulo: 'Listado de cobros en PDF',
        texto: 'Genera un PDF con el listado completo de cobros del dia, con filtros por ruta, estado de cada cliente, cuota, saldo y datos de amortizacion. Ideal para imprimir y entregar al cobrador.',
      },
    ],
  },
  {
