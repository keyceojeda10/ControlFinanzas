...
export const NOVEDADES_VERSION = 18
    ...
    items: [
      {
        ...
        texto: 'Ahora puedes crear clientes sin numero de cedula. Marca la casilla "No tengo el numero de cedula" al crear un cliente o en el migrador express. Util cuando estas migrando tu cartera y no tienes el documento a la mano. Puedes agregarlo despues editando el cliente.',
      },
      {
        icon: 'calculator',
