...
export const NOVEDADES_VERSION = 23
...
export const NOVEDADES = [
  {
    ...
    items: [
      {
        icon: 'check',
        titulo: 'Aprobacion de prestamos',
        texto: 'El administrador ahora puede exigir que cada prestamo del cobrador pase por su aprobacion antes de desembolsarse. Activa la opcion en Configuracion y recibe una notificacion push cada vez que un cobrador solicite un prestamo. Aprueba o rechaza con un toque.',
      },
      {
        icon: 'document',
        titulo: 'Pagare digital en PDF',
        texto: 'Genera un pagare legal con todos los datos del prestamo, clausulas, tabla resumen y la firma del cliente. Descargalo como PDF desde el detalle de cualquier prestamo que tenga firma digital.',
      },
      {
        icon: 'chart',
        titulo: 'Ranking de cobradores',
        texto: 'Nuevo scorecard que califica a cada cobrador en recaudo, puntualidad, mora y pruebas de visita. Ve quien rinde mas y quien necesita atencion. Disponible en Reportes para administradores.',
      },
      {
        icon: 'camera',
        titulo: 'Prueba digital de visita',
        texto: 'Los cobradores ahora pueden tomar una foto con GPS y hora exacta al visitar a cada cliente. El administrador ve las pruebas en el detalle del cobro y en el ranking. Ideal para verificar que la ruta se cumplio.',
      },
    ],
  },
  {
