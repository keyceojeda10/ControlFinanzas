...
export const ACCIONES = {
  ...
  calificar_cliente: { label: 'Calificó cliente',      icon: 'star',        color: '#f59e0b' },
  ...
  adicionales_cambiados: { label: 'Cambió cobradores o rutas adicionales', icon: 'pencil', color: '#8b5cf6' },
  adicionales_comprados: { label: 'Compró cobradores o rutas adicionales', icon: 'user-plus', color: '#22c55e' },

  // ── PRÉSTAMOS ──
  renovar_prestamo:  { label: 'Renovó préstamo',       icon: 'banknotes',  color: '#22c55e' },
  // Renovar sin entregar plata: la deuda más el interés pactado, desde hoy. Ver lib/financiar.js.
  financiar_prestamo: { label: 'Financió el saldo',    icon: 'banknotes',  color: '#22c55e' },
  ...
  // Deshacer una corrección metida a mano. Se anota aparte de ponerla: en el
  // historial hay que poder ver quién la quitó y cuándo, no solo quién la puso.
  movimiento_caja_deshecho: { label: 'Corrección de caja deshecha', icon: 'arrows', color: '#3b82f6' },
  ...
  deshacer_cierre_caja: { label: 'Deshizo el cierre de caja', icon: 'calculator', color: '#ef4444' },
  ...
  /* No la hizo el dueño: la anota el sistema al crear clientes desde un lote de
     fotos, para saber si el OCR acierta. Sale en el historial porque ahí es
     donde se ve qué pasó ese día, y una fila sin frase saldría en crudo. */
  ocr_precision:     { label: 'Leyó cartulinas con IA', icon: 'user-plus', color: '#3b82f6' },
