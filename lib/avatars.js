...
/* ⚠ NINGÚN SOMBRERO PUEDE BAJAR DE y=46. Los ojos están en cy=54 con radio
   4,6, o sea que empiezan en 49,4. El ala, el casco y el gorro de cocinero
   bajaban hasta 52-55 y les tapaban la mitad de arriba: en la hoja de prueba no
   se notaba, en el selector a tamaño grande sí — salían caras sin ojos. */
const sombrero = (c) => `<path d="M31,40 Q31,10 60,10 Q89,10 89,40 Z" fill="${c}"/><ellipse cx="60" cy="38" rx="56" ry="9" fill="${c}"/>`
...
const casco = (c) => `<path d="M28,42 Q28,10 60,10 Q92,10 92,42 Z" fill="${c}"/><rect x="12" y="35" width="96" height="11" rx="5.5" fill="${c}"/>`
const toque = (c) => `<path d="M30,38 Q30,2 60,2 Q90,2 90,38 Z" fill="${c}"/><rect x="28" y="32" width="64" height="12" rx="6" fill="${c}"/>`
