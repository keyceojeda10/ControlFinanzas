...
import { resumenPrecio } from '@/lib/precio-plan'
...
export function selectPreferenciales() {
  return {
    ...
    country: true,
    precioPreferencial: true, precioPreferencialPlan: true,
    precioPreferencialHasta: true, precioPreferencialNota: true,
    ...
    suscripciones: {
      ...
      take: 6,
      select: { plan: true, estado: true, montoCOP: true, fechaVencimiento: true, mpStatus: true },
    },
    users: {
      where: { rol: 'owner' },
      take: 1,
