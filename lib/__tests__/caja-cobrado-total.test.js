...
describe('el total cobrado se ve', () => {
  ...
  it('la pantalla enseña «Cobró hoy» DENTRO del grupo «Entra»', () => {
    ...
    expect(pantalla).toMatch(/cr\.cobradoTotal|cuentaRuta\?\.cobradoTotal/)
    // Y la resta del EFECTIVO sigue sin incluir lo digital: si entrara ahí, al
    // cobrador se le pediria un fajo de billetes que nunca tuvo.
