...
describe('⚠ el botón está en la parada cobrada', () => {
  ...
  it('solo sale cuando ya se cobró', () => {
    ...
    const i = src.indexOf('{cobrada && onDeshacerCobro && (')
  ...
  it('⚠ una parada cobrada sin más acciones tampoco se queda sin él', () => {
    ...
    expect(src).toMatch(/onLlamar \|\| onWhatsApp \|\| onMapa \|\| onMas \|\| \(cobrada && onDeshacerCobro\)/)
  })
