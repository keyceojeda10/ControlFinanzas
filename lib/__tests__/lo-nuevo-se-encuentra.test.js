...
describe('⚠ los sinónimos no se pisan entre sí', () => {
  it('cada frase lleva a UNA acción, no a la equivocada', () => {
    ...
    const casos = [
      ...
      ['multa', 'recargo'],
      // tal cual lo escribió un prestamista el 5 sep 2026, y no encontraba nada
      ['sumarle 15% mas de interes a lo que ya debe', 'recargo'],
      ['sumar interes', 'recargo'],
      /* Era 'renovar' mientras no existía «Financiar el saldo»: cobrar otro mes de
         interés sin entregar plata ES financiar (PRESTA MIL, 21 sep 2026). */
      ['cobrarle otro mes', 'financiar'],
      ['financiar la cartulina', 'financiar'],
      ['cobrarle intereses', 'financiar'],
