...
import { adaptarClientes, estadoVisual, iniciales, contextoDe, truncado, etiquetaDe, DIAS_MORA } from '@/lib/adaptadores/clientes'
...
describe('adaptarClientes', () => {
  ...
  it('los dias van DENTRO del texto de la pastilla, no en una segunda', () => {
    ...
    // UNA sola, en la primera linea, con los dias en el texto: «10d mora».
    ...
    expect(a.etiquetaEstado).toBe('36d mora')
  ...
  it('con cero dias no escribe «0d»', () => {
    ...
    // `estado === 'mora'` con CERO dias. Sin guardia saldria «0d vencido».
