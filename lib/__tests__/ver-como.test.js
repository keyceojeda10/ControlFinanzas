...
describe('las rutas y el proveedor', () => {
  ...
  it('ver-como: el cobradorId se valida como texto ANTES de consultar la base', () => {
    const r = src('app/api/ver-como/route.js')
    expect(r).toMatch(/typeof cobradorId !== 'string' \|\| !cobradorId/)
    expect(r.indexOf("typeof cobradorId !== 'string'")).toBeLessThan(r.indexOf('prisma.user.findFirst'))
  })
