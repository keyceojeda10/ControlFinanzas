...
describe('filasAtencion', () => {
  ...
  it('la mora va primero y en rojo', () => {
    ...
    expect(filas[0].texto).toBe('5 clientes en mora')
  ...
  it('singular sin "(s)"', () => {
    expect(filasAtencion({}, 1)[0].texto).toBe('1 cliente en mora')
    expect(filasAtencion({ clientesSinRuta: 1 }, 0)[0].texto).toBe('1 cliente sin ruta asignada')
  })
})
