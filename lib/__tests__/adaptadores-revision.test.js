...
describe.skipIf(!hayArchivo)('contra el archivo real de 68 créditos', () => {
  ...
  it('los 45 teléfonos rotos SÍ son problema de sus filas', () => {
    /* ⚠ Eran 44 hasta el 9 sep 2026. El que se sumó es una mejora: la fila 14
       trae veinte dígitos —dos números pegados— y el filtro viejo lo daba por
       bueno solo porque pasaba de diez. Ver `importar-excel`. */
    const v = vista()
    expect(v.porFila.find((r) => r.campo === 'telefono')?.n).toBe(45)
  })
