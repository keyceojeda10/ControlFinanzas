...
function llamadas() {
  const out = []
  // La carga masiva vive en lib/ desde el 24 sep 2026 (la usan la pantalla y el soporte).
  for (const p of [...jsDe(resolve(RAIZ, 'app')), resolve(RAIZ, 'lib/importar-cartera.js')]) {
