...
import { tramosDePlan, limiteInicial, loQueDesbloquea, recomendarPlan, planMinimo, pesoDelPlan, adaptarPlanExcedido, razonDelPlan } from '@/lib/adaptadores/planes'
...
describe('tramosDePlan', () => {
  ...
  it('lo que desbloquea sale de PLANES_CONFIG y pone el cobrador primero', () => {
    ...
    // El salto de verdad es Crecimiento: ahí aparece gente cobrando.
    expect(t[2].desbloquea).toContain('2 personas cobrando')
