...
describe('las dos pantallas beben de las mismas funciones', () => {
  ...
  it('⚠ y pide el `modoInteres`, sin el cual el reparto se equivoca en silencio', () => {
    ...
    // La ventana creció el 20 sep 2026: entre el OR y el select entró la línea de
    // los abiertos con su nota. La intención es la misma: el select de ESA consulta.
    expect(api.slice(i, i + 1500)).toContain('modoInteres: true,')
  })
