...
describe('T09-02 · los dos grupos', () => {
  ...
  it('las desactivadas no cuentan como problema', () => {
    ...
    // Con una sola cuenta la frase iba en plural: «1 cuenta sin ruta NO PUEDEN
    // cobrar nada». La frase entera vive en el adaptador por eso.
    expect(r.aviso.resto).toContain('no puede cobrar')
    expect(r.aviso.resto).not.toContain('pueden')
  })
