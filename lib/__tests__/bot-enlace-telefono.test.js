...
describe('⚠ el momento post-registro', () => {
  ...
  it('⚠ y NO se deriva al número de soporte', () => {
    /* Medido: 274 derivaciones a ese número en julio y agosto, 4 tickets en
       toda la historia del producto. Convierte cerca del 1 %. */
    expect(cartera).not.toMatch(/301\s*199\s*3001/)
    expect(cartera).not.toMatch(/3011993001/)
  })
  ...
  it('el saludo dice el nombre cuando lo hay, y no se rompe cuando no', () => {
    ...
    expect(mensajeBienvenida('')).toMatch(/^Listo\. /)
