...
describe('la parada actual', () => {
  ...
  it('se distingue por el borde y el aviso, NO por tener botones', () => {
    ...
    // Desde el 7 de agosto tampoco dependen de estar sin cobrar: la parada hecha
    // conserva sus iconos —el recibo por WhatsApp se manda DESPUES de cobrar—
    // pero no el boton dorado, que ahi ya no tiene nada que cobrar.
    expect(pantalla).toMatch(/\{\(onLlamar \|\| onWhatsApp \|\| onMapa \|\| onMas\)/)
  })
