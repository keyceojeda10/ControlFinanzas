...
describe('el título lo pone el armazón, no la página', () => {
  ...
  it('ninguna página con cabecera dibuja además su propio <h1>', () => {
    ...
    const CONOCIDAS = [
      '/caja/cobrador/x', '/capital', '/carga-masiva',
      '/clientes/x/editar', '/clientes/x/historial',
      '/clientes/nuevo', '/cobradores/x', '/configuracion/plan',
      '/dashboard/analiticas', '/migrador', '/mis-estadisticas', '/reportes', '/soporte',
