...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 20px;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
      <tr><td align="center">
        <img src="https://app.control-finanzas.com/api/logo" width="200" alt="Control Finanzas" style="display:block;height:auto;margin:0 auto;" />
      </td></tr>
    </table>
    <div style="background-color:#1a1a1a;background-image:linear-gradient(135deg, rgba(245,197,24,0.03) 0%, #1a1a1a 40%, #1a1a1a 70%, rgba(245,197,24,0.02) 100%);border:1px solid #2a2a2a;border-radius:16px;padding:28px;">
      ${contenido}
    </div>
...
<div style="text-align:center;margin-top:24px;">
  <a href="${url}" style="display:inline-block;background:#f5c518;color:#0a0a0a;font-weight:700;font-size:14px;padding:12px 28px;border-radius:12px;text-decoration:none;box-shadow:0 4px 16px rgba(245,197,24,0.25);">
    ${texto}
  </a>
</div>`
    ...
    html: layout(`
      <div style="text-align:center;margin-bottom:16px;">
        <div style="width:56px;height:56px;border-radius:50%;background:rgba(245,197,24,0.1);border:2px solid rgba(245,197,24,0.2);display:inline-block;text-align:center;line-height:56px;">
          <span style="color:#f5c518;font-size:28px;font-weight:700;">@</span>
        </div>
      </div>
...
export function emailBienvenida({ nombre, email, nombreOrg, fechaVencimiento }) {
  ...
  return {
    ...
    html: layout(`
      ...
      <div style="background-color:#111111;background-image:linear-gradient(135deg, rgba(245,197,24,0.06) 0%, #111111 50%, #111111 100%);border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;">
...
export function emailPagoAprobado({ nombre, plan, monto, fechaVencimiento }) {
  ...
  return {
    ...
    html: layout(`
      ...
      <div style="background-color:#111111;background-image:linear-gradient(135deg, rgba(34,197,94,0.06) 0%, #111111 50%, #111111 100%);border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;">
        <table style="width:100%;border-collapse:collapse;">
...
export function emailReferidoExitoso({ nombre, nombreReferido }) {
  return {
    ...
    html: layout(`
      ...
      <div style="background-color:#111111;background-image:linear-gradient(135deg, rgba(34,197,94,0.06) 0%, #111111 50%, #111111 100%);border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;text-align:center;">
...
export function emailOnboardingDia1({ nombre }) {
  return {
    ...
    html: layout(`
      ...
      <div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-top:20px;">
        <p style="color:#888;font-size:12px;margin:0 0 8px;">🎬 ¿Prefieres ver cómo se hace? Mira estos tutoriales:</p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=b5x-lWu_vbA&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=5" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Primeros pasos</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=EEGrlsU-k7Y&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=6" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo registrar un cliente</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=bbdJsxiKMX8&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=8" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo crear un préstamo</a></p>
      </div>
    `),
  }
}
...
export function emailOnboardingDia3({ nombre, clientesCreados }) {
  const videoTip = clientesCreados > 0
    ? `<div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-top:16px;">
        <p style="color:#888;font-size:12px;margin:0 0 8px;">🎬 Tutorial recomendado:</p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=tldha8LjE4c&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=11" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo crear una ruta de cobro</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=zQdJ8019zrQ&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=10" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo agregar un cobrador</a></p>
       </div>`
    : `<div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-top:16px;">
        <p style="color:#888;font-size:12px;margin:0 0 8px;">🎬 Míralo en video, es más fácil:</p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=EEGrlsU-k7Y&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=6" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo registrar un cliente (1 min)</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=bbdJsxiKMX8&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=8" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Cómo crear un préstamo</a></p>
       </div>`
  ...
  return {
    ...
    html: layout(`
      ...
      <div style="text-align:center;margin-top:16px;">
        <a href="https://www.youtube.com/watch?v=CPnWwHtrTiQ&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=9" style="color:#f5c518;font-size:13px;text-decoration:none;">🎬 Ver tutorial: Cómo registrar un cobro y enviar comprobante</a>
      </div>
    `),
  }
}
  ...
  return {
    ...
    html: layout(`
      ...
      <div style="background-color:#111111;background-image:linear-gradient(135deg, rgba(245,197,24,0.06) 0%, #111111 50%, #111111 100%);border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          <tr><td style="color:#fff;font-size:13px;padding:6px 0;font-weight:600;">Basico</td><td style="color:#f5c518;font-size:13px;text-align:right;">$59.000/mes</td></tr>
          <tr><td style="color:#fff;font-size:13px;padding:6px 0;font-weight:600;">Crecimiento</td><td style="color:#f5c518;font-size:13px;text-align:right;">$79.000/mes</td></tr>
          ...
          <tr><td style="color:#fff;font-size:13px;padding:6px 0;font-weight:600;">Empresarial</td><td style="color:#f5c518;font-size:13px;text-align:right;">$259.000/mes</td></tr>
        </table>
      </div>

      <p style="color:#888;font-size:13px;margin:0;">Si no renuevas, perderas acceso a tu cartera y datos (se guardan por 30 dias).</p>
...
export function emailOnboardingDia14({ nombre }) {
  return {
    ...
    html: layout(`
      ...
      <p style="color:#888;font-size:13px;margin:0;">Tus datos estan seguros por 30 dias adicionales si no renuevas.</p>
...
export function emailRecuperacionDia17({ nombre, clientesCreados, prestamosCreados }) {
  ...
  return {
    ...
    html: layout(`
      <h2 style="color:#fff;font-size:18px;margin:0 0 8px;text-align:center;">Hola ${nombre}, ¿todo bien?</h2>
      <p style="color:#888;font-size:14px;margin:0 0 20px;text-align:center;">
      ...
      <div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;text-align:center;">
        <p style="color:#888;font-size:12px;margin:0 0 8px;">Lo que dejaste en tu cuenta:</p>
        <p style="color:#fff;font-size:16px;font-weight:700;margin:0;">${clientesCreados} cliente${clientesCreados !== 1 ? 's' : ''} · ${prestamosCreados} préstamo${prestamosCreados !== 1 ? 's' : ''}</p>
      </div>` : ''}

      <p style="color:#888;font-size:13px;margin:0 0 8px;">Activa tu plan desde <strong style="color:#fff;">$59.000/mes</strong> y recupera el acceso a toda tu información.</p>
      <p style="color:#888;font-size:13px;margin:0;">¿Necesitas ayuda o tienes alguna duda? Escríbenos a <a href="mailto:${SOPORTE}" style="color:#f5c518;text-decoration:none;">${SOPORTE}</a></p>
      ${boton('Reactivar mi cuenta', APP_URL + '/configuracion/plan')}

      <div style="text-align:center;margin-top:16px;">
        <a href="https://www.youtube.com/playlist?list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk" style="color:#f5c518;font-size:12px;text-decoration:none;">🎬 Ver tutoriales en video</a>
      </div>
    `),
  }
}
...
export function emailRecuperacionDia21({ nombre }) {
  return {
    ...
    html: layout(`
      <h2 style="color:#fff;font-size:18px;margin:0 0 8px;text-align:center;">Queremos ayudarte, ${nombre}</h2>
      <p style="color:#888;font-size:14px;margin:0 0 20px;text-align:center;">
      ...
      <div style="background-color:#111111;background-image:linear-gradient(135deg, rgba(34,197,94,0.06) 0%, #111111 50%, #111111 100%);border:1px solid rgba(34,197,94,0.2);border-radius:12px;padding:20px;margin-bottom:16px;text-align:center;">
        ...
        <p style="color:#888;font-size:13px;margin:0;">Escríbenos y te extendemos la prueba para que puedas configurar todo con calma.</p>
      </div>

      <p style="color:#888;font-size:13px;margin:0 0 8px;">Muchos prestamistas necesitan unos días más para probar bien el sistema. No hay problema.</p>
      <p style="color:#888;font-size:13px;margin:0 0 16px;">Escríbenos a <a href="mailto:${SOPORTE}" style="color:#f5c518;text-decoration:none;">${SOPORTE}</a> y te reactivamos la prueba.</p>

      <div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;">
        <p style="color:#888;font-size:12px;margin:0 0 8px;">🎬 Si no tuviste tiempo de explorar, mira estos tutoriales rápidos:</p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=b5x-lWu_vbA&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=5" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Primeros pasos (configura tu negocio)</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=CPnWwHtrTiQ&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=9" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Registrar cobros y enviar comprobantes</a></p>
        <p style="margin:4px 0;"><a href="https://www.youtube.com/watch?v=zQdJ8019zrQ&list=PLY7xKt7sjM3PnG5Tly5Xght2cvu-q7jvk&index=10" style="color:#f5c518;font-size:13px;text-decoration:none;">▶ Agregar cobradores a tu equipo</a></p>
      </div>
...
export function emailRecuperacionDia30({ nombre, clientesCreados, prestamosCreados }) {
  ...
  return {
    ...
    html: layout(`
      ...
      <h2 style="color:#fff;font-size:18px;margin:0 0 8px;text-align:center;">Último aviso, ${nombre}</h2>
      <p style="color:#888;font-size:14px;margin:0 0 20px;text-align:center;">
        Tu cuenta lleva más de 2 semanas inactiva. Por seguridad, eliminaremos los datos próximamente.
      </p>

      ${tieneData ? `
      <div style="background:rgba(239,68,68,0.05);border:1px solid rgba(239,68,68,0.2);border-radius:12px;padding:16px;margin-bottom:16px;text-align:center;">
        <p style="color:#ef4444;font-size:13px;font-weight:600;margin:0 0 4px;">Se perderán:</p>
        <p style="color:#fff;font-size:16px;font-weight:700;margin:0;">${clientesCreados} cliente${clientesCreados !== 1 ? 's' : ''} · ${prestamosCreados} préstamo${prestamosCreados !== 1 ? 's' : ''}</p>
      </div>` : ''}

      <p style="color:#888;font-size:13px;margin:0 0 16px;">Activa cualquier plan para conservar tu información. Planes desde <strong style="color:#f5c518;">$59.000/mes</strong>.</p>
