...
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px 20px;">
    <div style="text-align:center;margin-bottom:28px;">
      <img src="${APP_URL}/logo-icon.svg" alt="Control Finanzas" width="48" height="48" style="display:block;margin:0 auto 12px;border-radius:8px;" />
      <h1 style="color:#f5c518;font-size:20px;margin:0;">Control Finanzas</h1>
    </div>
    ...
    html: layout(`
      ...
      <div style="background:#111;border:1px solid #2a2a2a;border-radius:12px;padding:16px;margin-bottom:16px;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          <tr><td style="color:#888;font-size:12px;padding:4px 0;">Plan</td><td style="color:#f5c518;font-size:14px;text-align:right;font-weight:600;">Prueba gratuita (15 días)</td></tr>
