...
export const SINONIMOS_GESTION = {
  ...
  /* ⚠ COMO LO DIJO PRESTA MIL, EN UN VÍDEO (21 sep 2026): «financiar la
     cartulina 30 días más», «cobrar intereses», «que arranque en cero», «que la
     fecha empiece hoy». Buscaba en el recargo porque no había otra cosa. */
  /* Sin «intereses» a secas ni «más tiempo»: el primero le robaría la búsqueda
     al recargo y a cambiar el modo, y el segundo es de «Modificar el plazo», que
     alarga SIN cobrar más. Financiar es las dos cosas a la vez. */
  financiar: ['financiar', 'financiar la cartulina', 'financiarle', 'refinanciar', 'financiacion',
    'cobrar intereses', 'cobrarle intereses', 'otro mes de interes', 'cobrarle otro mes',
    '30 dias mas', 'acuerdo', 'arreglo', 'empezar de cero', 'mora en cero', 'quitar la mora',
    'fecha de hoy', 'prorroga', 'prorrogar'],
  // «refinanciar» y «cobrarle otro mes» se fueron a `financiar` el 21 sep 2026:
  // cobrar otro mes sin entregar plata es financiar, no prestar más.
  renovar: ['renovar', 'renovacion', 'volver a prestar', 'prestarle mas',
