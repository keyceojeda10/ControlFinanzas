...
export function derivarTabla(prestamo) {
  ...
  const opciones = {
    ...
    // Si el prestamo trae su primer cobro pactado, manda el suyo. Los viejos lo
    // tienen en null y siguen derivando el calendario de siempre.
    primerCobro: prestamo.primerCobro ? new Date(prestamo.primerCobro) : null,
  }
