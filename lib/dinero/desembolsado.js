...
const SELECT_FILA = {
  ...
  montoPrestado: true,
  renovadoDeId: true,
  // Para decir «financió el saldo» en vez de «renovación». Ver `esFinanciacion`.
...
const filaDe = (p, monto, metodoPago = null) => ({
  ...
  // Financiar el saldo sale en la lista con $0 —no salió plata— y tiene que
  // decir lo que fue: la misma deuda con más tiempo, no una cartulina nueva.
