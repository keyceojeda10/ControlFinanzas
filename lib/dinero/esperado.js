...
export function tocaCobrarEn(prestamo, fecha, diasExcluidos = [], festivos = []) {
  ...
  if (freq === 'diario') {
    ...
    // marcha.
    //
    // Me parece que la regla de la original es discutible —el primer dia
    // cobrable despues del desembolso deberia contar— pero esta migracion
    // promete que NADA cambia para hoy. Si esa regla esta mal, se arregla
    // aparte, con su medicion y su nombre.
