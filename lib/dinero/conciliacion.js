...
export function resumirLibro(movimientos = [], saldoPrevio = null) {
  ...
  for (const m of orden) {
    ...
    // Lo que ESTE asiento movió, según su propia foto. Va antes del filtro
    // porque un asiento «sin efecto» que aun así mueva el saldo es justo el
    // descuadre que hay que cazar.
