// lib/asistente-tools.js — Definiciones de herramientas para Lucas IA (formato OpenAI/DeepSeek)
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          cedula:    { type: 'string', description: 'Número de cédula (solo dígitos, 6-12 caracteres)' },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          montoPrestado: { type: 'number', description: 'Monto a prestar en la moneda del negocio (número entero, sin puntos ni símbolo)' },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          monto:       { type: 'number', description: 'Monto en la moneda del negocio (número entero, sin puntos ni símbolo)' },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          clienteNombre: { type: 'string', description: 'Nombre del cliente para mostrar en confirmación' },
          monto:         { type: 'number', description: 'Monto pagado en la moneda del negocio (número entero, sin puntos ni símbolo)' },
...
export const TOOLS_COBRADOR = TOOLS_OWNER.filter(t =>
  ['lookup_client', 'register_payment', 'register_expense'].includes(t.function.name)
)
