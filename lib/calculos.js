...
export function calcularCapitalRestante(prestamo) {
  ...
  return Math.max(0, Math.round((Number(prestamo.montoPrestado) || 0) - capitalCubierto))
}
 ...
 */
export function calcularPrestamo({ montoPrestado, tasaInteres, diasPlazo, fechaInicio, frecuencia = 'diario', cuotaManual, modoInteres, redondeo, interesAdelantado = false }) {
