 ...
 * Los primeros 7 días después del vencimiento se consideran período de gracia (sin mora).
 * A partir del día 8 开始 cuenta la mora.
...
export function calcularDiasMora(prestamo) {
  ...
  const diasMora = diasTranscurridos - 7
