...
// Objeto literal plano, NO Object.fromEntries(). Derivarlo con codigo se
// ejecuta al cargar el modulo, y en un modulo tan importado como este eso puede
// disparar un "Cannot access before initialization" por orden de inicializacion
// entre modulos. Los valores son 30 / diasPeriodo (invariante mes = 30 dias):
//   diario 30/1=30 · semanal 30/7=4.2857 · quincenal 30/15=2 · mensual 30/30=1
const PERIODOS_POR_MES = { diario: 30, semanal: 30 / 7, quincenal: 2, mensual: 1 }
