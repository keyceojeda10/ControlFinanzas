...
export const OBJECIONES = [
  ...
  {
    id: 'ya_tengo', rx: /\bya tengo\b|\buso (?:excel|otra|una app)\b|\btengo (?:excel|una app|otro sistema)\b|\bmi cuaderno me sirve\b/i,
    responder: 'Bien, entonces ya sabe lo que vale tener control. La diferencia es que esto está hecho para prestamistas: cuotas diarias, mora, cobradores, recibos. No es un Excel genérico. Pruébelo y compare; si lo suyo le sirve más, se queda con lo suyo.',
  },
  {
