...
export async function responder(lead, historial, entrante) {
  ...
  if (semantica?.tutoriales) {
    return { mensaje: TUTORIALES[semantica.tutoriales] || TUTORIALES.lead, temperatura: lead.temperatura || 50, escalar: false,
      usage: { modelo: 'fijo', tokensIn: 0, tokensOut: 0, costoUsd: 0 }, traza: FIJO(`${clasificacionTraza}>tutoriales`) }
  }
