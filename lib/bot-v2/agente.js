...
export async function responder(lead, historial, entrante) {
  ...
  if (!resultado) {
    return {
      ...
      traza: { etapa: stage, clasificacion: clasificacionTraza, proveedor: 'ninguno', promptId: promptIdDe(stage, prompt, hist, lead.nombre, entrante.texto) },
    }
  }
  ...
  return {
    ...
    traza: {
      ...
      promptId: promptIdDe(stage, prompt, hist, lead.nombre, entrante.texto),
