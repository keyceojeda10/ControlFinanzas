...
const TUTORIALES_REGEX = /\b(?:tutorial(?:es)?|curso|capacitaci[oó]n)\b|\bvideos?\b|\b(?:el|un|los|algun|alg[uú]n|su) manual\b|\bmanual de (?:uso|usuario|la app|del sistema)\b|c[oó]mo se usa la app|ense[ñn]arme a usar/i
