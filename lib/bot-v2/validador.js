...
import { funcionesMencionadas, NO_EXISTE, PLANES, EXTRAS } from './kb.js'
...
export function correccionPara(motivos, { contexto, textoLead } = {}) {
  const L = {
    ...
    argumento_repetido: `Repetiste un argumento que YA usaste (${(contexto?.argumentosUsados || []).join(', ')}). Usa OTRO argumento o baja al detalle concreto de lo que el lead acaba de decir.`,
