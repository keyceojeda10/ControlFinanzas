...
export function promptValor({ nombre, historial, dolorDetectado, linkEnviado = false }) {
...
${linkEnviado ? `El enlace de registro YA se le mando antes (esta arriba en el historial). NO lo repitas ni le preguntes si se registro: responde a lo que acaba de decir. Solo si lo pide otra vez, se lo vuelves a poner: ${EMPRESA.linkRegistro}` : ''}
