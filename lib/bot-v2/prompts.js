...
TU TAREA: Da el precio del plan recomendado para su tamano. Menciona que tambien hay plan anual (2 meses gratis, un solo pago). Luego ofrece la prueba gratis.

Si el lead objeta "pago mensual" o quiere "un solo pago": ofrece el plan anual de una vez.
...
- "pago unico/un solo pago/no quiero mensual" -> "Tambien hay plan anual: un solo pago y le quedan 2 meses gratis. Pero primero pruebelo ${EMPRESA.diasPrueba} dias gratis."
