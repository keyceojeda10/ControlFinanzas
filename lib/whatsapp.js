 ...
 */
export function generarTextoComprobante(cliente, prestamo, pago, { orgNombre, ocultarSaldo } = {}) {
 ...
 */
export function generarEnlaceMora(cliente, prestamo, { orgNombre, ocultarSaldo } = {}) {
  const tel = formatearTelefono(cliente?.telefono)
  if (!tel) return null
