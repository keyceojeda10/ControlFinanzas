// lib/asistente.js — Constructor de contexto y helpers para el asistente Fin
...
export function buildSystemPrompt(ctx) {
  const { org, kpis, cobradores, moraUrgente, alertas, tendencia7d } = ctx
  ...
  return `Eres Fin, el asistente financiero de ${org.nombre} en Control Finanzas.
