...
export const MENSAJES = [
  ...
  {
    id: 19,
    label: 'Respuesta genérica (otro método)',
    category: 'respuesta',
    condition: 'Cuando el lead dice algo que no encaja en cuaderno/Excel/WhatsApp/otra app. Ej: "computador", "celular", "papel", "a mano", etc.',
    generate: ({ nombre }) => [
      `${saludo(nombre)}, perfecto — sin importar cómo lo lleves ahora, el sistema te va a facilitar bastante el trabajo.`,
      ``,
      `Registras tus préstamos, el sistema calcula las cuotas automático, y si tienes cobradores cada uno lleva su ruta desde el celular. Tú ves todo en tiempo real.`,
      ``,
      `Pruébalo 14 días gratis, sin tarjeta:`,
      `https://app.control-finanzas.com/registro`,
      ``,
      `¿Tienes cobradores o cobras tú mismo?`,
    ].join('\n'),
  ...
  {
    id: 20,
    label: 'Post-registro: ya verificó correo',
    category: 'respuesta',
    condition: 'Cuando el lead dice "ya hice todo", "ya verifiqué el correo", "ya me registré y confirmé". Guiarlo en los siguientes pasos.',
    generate: ({ nombre }) => [
      `Perfecto ${saludo(nombre)}, ya estás listo.`,
      ``,
      `Lo primero que te recomiendo:`,
      `1. Entra al sistema y registra tu primer cliente de prueba`,
      `2. Crea un préstamo para ver cómo calcula las cuotas`,
      `3. Si tienes cobradores, agrégalos desde el menú de usuarios`,
      ``,
      `Cualquier duda me escribes, estoy pendiente.`,
      ``,
      `Y si prefieres, te hago una videollamada de 5 minutos para mostrarte todo.`,
    ].join('\n'),
  },
