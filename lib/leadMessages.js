...
export const MENSAJES = [
  ...
  },
  {
    ...
    generate: ({ nombre }) => [
      ...
      ``,
      `Nosotros no préstamos dinero — Control Finanzas es un sistema para personas que *ya prestan* dinero y quieren llevar el control de sus cobros, clientes y cobradores.`,
      ``,
  ...
  },
  {
    ...
    generate: () => [
      `El plan inicial sale en $39.000 al mes. Pero primero pruébalo 14 días gratis sin meter tarjeta.`,
      ``,
  ...
  },
  {
    ...
    generate: ({ nombre }) => [
      ...
      ``,
      `Si quieres seguir usándolo después del día 14, el plan inicial son $39.000/mes y te incluye todo lo que ya estás usando.`,
      ``,
