...
export const MENSAJES = [
  ...
  },
  {
    ...
    generate: () => [
      `El plan básico sale en $59.000 al mes. Pero primero pruébalo 14 días gratis sin meter tarjeta.`,
      ``,
  ...
  // ── OBJECIONES ───────────────────────────────────────────────
  {
    ...
    generate: ({ nombre }) => [
      ...
      ``,
      `La mayoría de prestamistas pierden más de $59.000 al mes en cobros mal anotados y ni se dan cuenta.`,
      ``,
