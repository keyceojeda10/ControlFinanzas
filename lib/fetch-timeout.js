 ...
 *
 * ⚠ Y SUBIR fotos, que no llama a Gemini pero pesa igual: diez fotos de
 * teléfono son decenas de megas por una red móvil de barrio. Con el presupuesto
 * normal de 8 s, la donación se abortaría igual que se abortaba la lectura, y
 * con el mismo mensaje que no señala a ningún sitio. Es el segundo caso: por
 * eso el nombre pasa a hablar de fotos, no de lectura. */
const esLecturaDeFotos = (u) =>
  u.includes('/api/herramientas/leer-cartulina') || u.includes('/api/fotos-donadas')
