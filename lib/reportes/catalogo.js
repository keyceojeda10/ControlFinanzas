...
export const INFORMES = [
  ...
  },
  {
    ...
    nivel: 2,
    /* ⚠ UN SOLO PERÍODO, Y NO ES UN RECORTE: ES LO QUE EL API CONTESTA.
       Declaraba cuatro y `dashboard/analiticas` no lee un solo parámetro —
       siempre calcula el mes en curso más la tendencia de seis. Los cuatro
       chips se pintaban, se pulsaban y devolvían exactamente lo mismo: un
       control que miente es peor que no tenerlo. Comprobado pidiendo los
       cuatro y comparando: idénticos.
       Si algún día el API acepta rango, aquí se vuelven a poner. */
    periodos: ['mes'],
  ...
  },
  {
    ...
    /* ⚠ LO QUE ENTREGA DE VERDAD, para que el botón no mienta.
       ...
       en nada. */
    formatoPropio: 'pdf',
    /* ⚠ `trae` ES OBLIGATORIO EN LOS QUE NO TIENEN VISTA. Su pantalla no puede
       enseñar nada —no hay qué pintar— y quedaba un botón solo, sin decir qué
       baja ni de cuándo. Esto es lo que sale en el papel, renglón a renglón. */
    trae: [
      'Cada cliente al que le toca cobro hoy, con su dirección y su teléfono.',
      'Lo que debe pagar y lo que lleva pagado del préstamo.',
      'Un espacio en blanco para anotar a mano lo que recibió.',
    ],
    atajoDesde: '/reportes',
  },
  {
  ...
  },
  {
    ...
    /* Decía «para el contador» y se confundía con el informe QUE SE LLAMA «Para
       el contador»: parecían el mismo dos veces. No lo son —aquel calcula la
       utilidad, este vuelca las tablas tal como están— y ahora cada uno dice lo
       suyo. */
    contesta: 'Tus cuatro tablas tal como están, en un solo Excel de cuatro hojas.',
    nivel: 1,
    periodos: ['todo'],
    ver: null,
    ...
    formatoPropio: 'excel',
    // Ver la nota de `trae` en «Listado de cobros».
    trae: [
      'Clientes: nombre, cédula, teléfono, dirección y desde cuándo son tuyos.',
      'Préstamos: monto, tasa, plazo, lo pagado y lo que falta, uno por renglón.',
      'Pagos: fecha, monto, quién lo recibió y a qué préstamo se le abonó.',
      'Cobradores: quién es cada uno y qué rutas lleva.',
    ],
    atajoDesde: '/reportes/bajar',
  },
]
