    ...
    prisma.cliente.findMany({
      ...
      include: {
        ...
        prestamos: {
          ...
          include: {
            /* Los pagos y la tabla NO son opcionales: `calcularSaldoPendiente` y
               `calcularDiasMora` los leen, y un campo que no se pide vale
               `undefined` sin dar error — así nació el «0 en mora» que estuvo
               meses en Analíticas. */
