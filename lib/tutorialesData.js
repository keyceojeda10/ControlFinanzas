...
export const TUTORIALES = [
  ...
  // ════════════════════════════════════════════
  {
    ...
    images: [{ src: '/tutoriales/01_login.png', caption: 'Pantalla de entrada' }],
    text: `📱 *Cómo registrarse en Control Finanzas*

1. Entra a *app.control-finanzas.com*
2. Toca *"Regístrate gratis"*, debajo del botón de entrar
...
💡 Usa un correo que revises seguido: ahí llegan los avisos del sistema.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/02_dashboard.png', caption: 'Sin verificar sale una franja arriba del panel' }],
...
💡 Si no llega en 5 minutos, mira en spam. El enlace solo sirve una vez.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/02_dashboard.png', caption: 'El panel: lo de hoy arriba, lo demás abajo' }],
...
💡 Toca *"Ver todo lo demás"* para el resto de las cifras, y *"Preguntar a Lucas"* para pedirle cuentas al asistente en español.`,
  ...
  // ════════════════════════════════════════════
  {
    ...
    images: [
      ...
      { src: '/tutoriales/04_cliente_nuevo.png', caption: 'Formulario de cliente' },
    ],
...
💡 Puedes tomarle *foto* al cliente o buscarla en la *galería* desde el mismo formulario.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/05_cliente_detalle.png', caption: 'Ficha del cliente — botón "Editar"' }],
...
💡 Cambiarle la *ruta* lo mueve de recorrido de una vez.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/05_cliente_detalle.png', caption: 'Ficha del cliente — Inactivar y Eliminar' }],
...
⚠️ Eliminar no se puede deshacer. Ante la duda, *inactiva*.`,
  },
  {
    ...
    images: [
      { src: '/tutoriales/07_prestamo_nuevo.png', caption: 'Paso 1: a quién le prestas' },
...
💡 Si te presta plata un socio o sale de una cuenta distinta, escógela en el paso 2.`,
  },
  {
    ...
    images: [
      { src: '/tutoriales/08_prestamo_pago.png', caption: 'Préstamo — botón "Pagar ahora"' },
      { src: '/tutoriales/19_cobros_hoy.png', caption: 'Cobros de hoy — botón "Cobrar" en cada renglón' },
    ],
...
⚠️ ¿Pagó de más para bajar la deuda? Eso no es un cobro normal: mira *"Cómo hacer un abono a capital"*.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/25_prestamo_abonos.png', caption: 'Préstamo → "Abonos"' }],
...
💡 Después del abono, el sistema recalcula lo que falta.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/24_prestamo_gestion.png', caption: 'Préstamo → "Gestión" → Recargo y Descuento' }],
...
💡 En esa misma hoja está *"Modificar el plazo"* si lo que quieres es darle más cuotas.`,
   ...
   * OTRO (el cobrador, a quien se le reenvía) o lo que no es la app. */
  {
    ...
    images: [{ src: '/tutoriales/28_gestion_menu.png', caption: 'Está dentro de «Gestión»' }],
...
💡 Atajo: dentro del préstamo, escribe *"renovar"* en «¿Qué necesitas hacer aquí?» y se abre directo.`,
  },
  {
    ...
    keywords: ['cancelar', 'anular prestamo', 'eliminar prestamo', 'borrar prestamo',
      'me equivoque', 'deshacer'],
    destino: { texto: 'Elegir el préstamo', href: '/prestamos' },
    images: [{ src: '/tutoriales/28_gestion_menu.png', caption: 'Al final de «Gestión», en rojo' }],
...
💡 Solo el dueño puede cancelar.`,
  },
  {
    ...
    destino: { texto: 'Elegir el préstamo', href: '/prestamos' },
    images: [{ src: '/tutoriales/28_gestion_menu.png', caption: 'En «Gestión», con el monto ya calculado' }],
...
💡 La cifra ya viene calculada: no la saques a mano.`,
  },
  {
    ...
    destino: { texto: 'Elegir el préstamo', href: '/prestamos' },
    images: [{ src: '/tutoriales/28_gestion_menu.png', caption: 'En «Gestión», con el plazo actual al lado' }],
...
💡 Si lleva más de 15 días sin pagar, la app misma te sugiere esto antes que el recargo.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/28_gestion_menu.png', caption: 'En «Gestión», al final' }],
...
⚠️ No es cancelar. Aquí la plata SÍ salió: por eso sigue restando de tu capital.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/09_rutas_lista.png', caption: 'Rutas — el botón + arriba a la derecha' }],
...
💡 El orden de las rutas lo cambias con *"Ordenar"*.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/10_ruta_detalle.png', caption: 'Detalle de ruta — "Agregar cliente"' }],
...
💡 Desde la ruta también puedes *"Imprimir hoja"* y llevar el recorrido en papel.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/10_ruta_detalle.png', caption: 'Detalle de ruta — "Reordenar recorrido"' }],
...
💡 Ese orden es el que ve el cobrador cuando toca *"Empezar recorrido"*: ponlos como quedan de camino, no por orden alfabético.`,
  },
  {
    ...
    images: [
      { src: '/tutoriales/19_cobros_hoy.png', caption: 'Cobrar hoy — todo lo del día' },
      { src: '/tutoriales/10_ruta_detalle.png', caption: 'La ruta, con "Empezar recorrido"' },
    ],
...
💡 Si no vas a pasar por alguien, *reagenda la visita* desde su ficha en vez de dejarlo sin cobrar.`,
  },
  {
    ...
    images: [
      { src: '/tutoriales/11_cobradores_lista.png', caption: 'Cobradores — "Crear cobrador"' },
      { src: '/tutoriales/12_cobrador_nuevo.png', caption: 'Formulario con los permisos' },
    ],
...
💡 En *"Ver el ranking"* comparas cuánto recogió cada uno.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/12_cobrador_nuevo.png', caption: 'Sección de permisos' }],
...
💡 Los cambios entran cuando el cobrador vuelva a abrir la app.`,
  ...
  // ════════════════════════════════════════════
  {
    ...
    images: [{ src: '/tutoriales/13_caja.png', caption: 'Caja del día' }],
...
💡 En *"Historial de cierres"* quedan todos los días anteriores.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/21_capital.png', caption: 'Capital' }],
...
💡 El capital *no es* la caja. La caja es la plata de hoy; el capital es todo lo que tienes puesto en el negocio, incluida la que está en la calle.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/22_socios.png', caption: 'Socios' }],
    text: `🤝 *Socios*
...
💡 Sirve para saber *de quién es* la plata que está en la calle y cuánto le corresponde a cada uno, sin sacar la cuenta a mano.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/23_caja_cuentas.png', caption: 'Caja → pestaña "Cuentas"' }],
...
💡 *"Por ruta"* te separa la caja de cada cobrador.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/14_reportes.png', caption: 'Reportes' }],
    text: `📈 *Reportes*
...
💡 Con *"Imprimir"* sacas el reporte en papel o en PDF.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/15_plan.png', caption: 'Mi plan' }],
    text: `💳 *Cómo pagar tu plan*

1. Entra a *Configuración → Plan y pagos*
2. Toca *"Renovar mi plan"*, o *"Cambiar de plan"* si quieres otro
...
💡 Si te pasas del tope de clientes, el sistema te avisa antes de bloquear nada.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/16_configuracion.png', caption: 'Configuración' }],
...
💡 Dejar bien *"Cómo prestas"* te ahorra tocarlo en cada préstamo.`,
  },
  {
    ...
    images: [
      { src: '/tutoriales/17_soporte_lista.png', caption: 'Soporte' },
      { src: '/tutoriales/18_soporte_nuevo.png', caption: 'Nuevo ticket' },
    ],
...
6. Si quieres que te llamemos, marca *"Solicitar que me contacten"*
...
💡 La captura de pantalla es lo que más rápido nos deja ver el problema.`,
  ...
  {
    id: 'offline',
    keywords: ['instalar', 'instalar aplicacion', 'descargar app', 'sin internet', 'offline', 'sin señal', 'poner en el celular'],
    categoria: 'extras',
    title: 'Cómo instalar la app y cobrar sin internet',
    images: [{ src: '/tutoriales/02_dashboard.png', caption: 'Instalada se ve como una app más' }],
...
💡 En esa misma pantalla ves quiénes se registraron con tu enlace y quiénes ya pagaron.`,
  },
  {
    ...
    images: [{ src: '/tutoriales/26_cliente_portal.png', caption: 'Ficha del cliente — "Activar portal"' }],
