...
⚠️ *Importante:*
• Solo usuarios con permiso de *gestión de préstamos* pueden aplicar recargos y descuentos
...
4. Configura los *permisos*:
  • Crear préstamos
  • Gestión de préstamos (renovar, modificar plazo, recargo/descuento)
  • Reportar gastos menores (viene activado por defecto)
  • Crear clientes
  • Editar clientes
...
5. Activa o desactiva cada permiso:
  ...
  🔘 *Gestión de préstamos* — Permite renovar, modificar plazos y aplicar recargos/descuentos
  🔘 *Reportar gastos menores* — Permite registrar gastos en caja
...
⚠️ *Importante:*
• El permiso de *reportar gastos menores* viene activo por defecto
• Puedes dejar solo permisos de cobro si no quieres darle gestión administrativa
...
• El saldo también aparece en el Dashboard como "Saldo disponible"`,
  },
  {
    ...
    images: [],
    text: `🤝 *Cómo manejar socios e inversionistas*

Si prestas con dinero de socios, este módulo lleva el control de cuánto puso cada uno y cuánto ha ganado.

📌 *Registrar un socio:*
1. En el menú, entra a *"Socios"*
2. Toca *"+ Nuevo socio"* y llena nombre, cédula y teléfono
3. Guarda

📌 *Registrar aportes y retiros:*
1. Entra al socio
2. Toca *"+ Aporte"* para registrar el dinero que mete a la sociedad (o *"Retiro"* cuando saca)
3. Cada aporte *suma* al capital disponible para prestar; cada retiro lo *baja*

📌 *Cómo se reparte la ganancia (importante):*
• Al crear un préstamo puedes asignarlo a un socio (campo *"Socio"*)
• Los intereses de *ese* préstamo se le atribuyen a ese socio a medida que el cliente paga
• En la ficha del socio ves:
   • *Total aportado* — cuánto ha puesto
   • *Intereses ganados* — su parte de las ganancias
   • *Rentabilidad (ROI)* — ganancia ÷ aporte × 100

⚠️ *Cómo funciona hoy:* la ganancia se reparte *por préstamo asignado*, no por un porcentaje fijo de participación. Dos socios que pusieron lo mismo pueden ganar distinto si tienen préstamos distintos asignados.

💡 *Tip:* Usa la *Liquidación* dentro de la ficha del socio para ver el resumen del período.`,
  },
  {
    id: 'medios-pago',
    categoria: 'admin',
    title: 'Cómo configurar y ver los medios de pago',
    images: [],
    text: `💳 *Cómo configurar y ver los medios de pago*

Puedes registrar con qué cuenta te pagó cada cliente (efectivo, Nequi, Daviplata, transferencia...).

📌 *Configurar tus cuentas:*
1. Entra a *Configuración*
2. Busca *"Métodos de pago"*
3. Agrega las cuentas que usas (ej: Nequi, Daviplata, Bancolombia) y marca cuál es la predeterminada

📌 *Al registrar un pago:*
1. Cuando registras un pago, elige *Efectivo* o *Transferencia*
2. Si es transferencia, escoge la cuenta (Nequi, Daviplata, etc.)

📌 *Ver cuánto entró por cada cuenta:*
• En *Caja*, en el resumen del día, aparece el *desglose por método de pago* (cuánto recibiste en efectivo y cuánto en cada cuenta)
• Ese desglose es de lo *recibido* en el período seleccionado

💡 *Tip:* Configurar bien tus cuentas te ayuda a cuadrar cuánto dinero tienes en cada billetera al final del día.`,
  },
  {
    id: 'reportes',
    categoria: 'admin',
...
📌 *Métricas principales:*
   ...
   • Préstamos activos
   • Cartera activa (cuánto te deben, con intereses)
   • Ingresos del período
   • Capital en la calle (tu plata, sin intereses)
...
Tu cliente puede consultar su préstamo, su saldo y los pagos que ha hecho desde su propio celular, sin llamarte ni pedirte cuentas.

*NO necesita descargar ninguna aplicación.* Es una página web: solo abre el enlace que tú le envías.

📌 *Cómo activarlo (solo el dueño puede)*

1. Entra a *"Clientes"* y abre la ficha del cliente
2. Busca la tarjeta *"Portal del cliente"*
3. Toca *"Activar portal"*
4. Escribe un *PIN de 4 a 6 dígitos* (solo números) y toca *"Guardar"*
5. Dile el PIN al cliente. Es la clave con la que va a entrar

📌 *Cómo enviarle el acceso*

En esa misma tarjeta aparece el botón para *copiar el enlace*. Pégalo en un WhatsApp al cliente junto con su PIN.

⚠️ *Importante:* usa siempre el enlace que copia el botón. Ese enlace lleva el identificador de tu negocio, y sin él tu cliente no va a poder entrar.

📌 *Cómo entra el cliente*

1. Abre el enlace que le enviaste
2. Escribe su *número de cédula* o su *número de teléfono* (el que tienes registrado en su ficha)
3. Escribe el *PIN* que le diste
4. Listo: ve sus préstamos, cuánto debe, cuánto ha pagado y cuándo es el próximo cobro

📌 *Cómo quitarle el acceso*

En la misma tarjeta hay un interruptor. Apágalo y el cliente deja de entrar, sin borrar nada. Lo puedes volver a prender cuando quieras.

💡 *Tips:*
• El cliente solo ve SU información. Nunca ve otros clientes ni tus números del negocio
• Si se equivoca 5 veces con el PIN, el sistema lo bloquea 15 minutos
• Si el cliente no recuerda el PIN, entra a su ficha y guarda uno nuevo
• Verifica que la cédula o el teléfono en la ficha estén bien escritos: son los datos con los que entra`,
  },
]
