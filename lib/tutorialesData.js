...
export const CATEGORIAS = [
  { id: 'inicio', label: 'Primeros pasos', icon: '🚀', color: '#22c55e' },
  { id: 'clientes', label: 'Clientes y préstamos', icon: '👥', color: '#3b82f6' },
  { id: 'cobro', label: 'Cobro y rutas', icon: '🗺️', color: '#f59e0b' },
  { id: 'admin', label: 'Administración', icon: '⚙️', color: '#8b5cf6' },
  { id: 'extras', label: 'Herramientas extra', icon: '🛠️', color: '#ec4899' },
]
...
💡 *Tip:* Entre más detalle des en la descripción, más rápido podemos ayudarte.`,
  ...
  // ════════════════════════════════════════════
  {
    ...
    categoria: 'extras',
    emoji: '📶',
    title: 'Cómo usar la app sin internet (modo offline)',
    images: [],
    text: `📶 *Cómo usar la app sin internet (modo offline)*

Control Finanzas funciona incluso cuando no tienes conexión a internet. Esto es ideal para cuando estás cobrando en zonas sin señal.
...
2. Te aparecerá un aviso para instalar la app, toca *"Instalar"*
3. Si no aparece, toca los 3 puntos del menú → *"Instalar app"*

*En computador (Chrome):*
1. Abre *app.control-finanzas.com*
2. En la barra de direcciones verás un ícono de descarga o en el menú *"Instalar Control Finanzas"*
