...
//
// Antes salian por WhatsApp (OpenWA) al numero personal. Ahora el bot comercial
// es OTRO numero (Cloud API), asi que las alertas internas van por TELEGRAM
// (canal 'notif' de lib/telegram), que es independiente del WhatsApp y gratis.
// Asi, si el WhatsApp del bot tuviera problemas, la alerta igual llega.
