...
export const KEYWORDS_PAGO = [
  'quiero pagar', 'como pago', 'donde pago', 'activar plan', 'activar mi plan',
  'se me acabo', 'se me termino',
  'se vencio', 'se me vencio', 'vencio mi prueba', 'vencio la prueba',
  'acabo mi prueba', 'acabo la prueba', 'termino la prueba',
  'como contrato', 'como sigo',
  'quiero el plan', 'quiero seguir', 'renovar',
  'comprar el plan', 'adquirir',
]
