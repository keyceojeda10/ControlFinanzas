...
- NO expliques mas por texto. Ofrece contacto humano DE INMEDIATO:
  "Tranquilo, le agendamos una videollamada de 15 min y le mostramos todo en vivo: ${DATOS_SISTEMA.linkCalendario15}. O si prefiere, escribale al ${DATOS_SISTEMA.telefonoSoporte} y lo ayudan directo."
- Marca escalar=true, motivo="cliente frustrado con la plataforma"
