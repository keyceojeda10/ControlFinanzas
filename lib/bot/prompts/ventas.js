...
/* El bloque de VIDEOS se quito el 16 ago 2026: interpolaba `${VIDEOS.x}`, una
   variable que NO EXISTE en ningun sitio, dentro de una plantilla viva. Habria
   reventado al construir el prompt. Y ya sobraba: tres lineas mas arriba el
   propio texto dice «NO ofrezcas video (los que hay son de antes del
   redisenno)». Lo cazó encender `no-undef`. */
