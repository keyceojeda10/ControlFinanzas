...
//
// ⚠⚠ ESTO YA NO ES EL BOT. NO LO LEAS PARA SABER QUÉ PUEDE DECIR. ⚠⚠
//
// Es la generación anterior (`lib/bot/`). El bot vivo es `lib/bot-v2/`, y lo
// que puede o no puede decir sale de **`lib/bot-v2/producto.js`**: las listas
// `FUNCIONES` y `NO_EXISTE`.
//
// Lo de aquí abajo está desactualizado y engaña: el 1 sep 2026 esta lista decía
// que el Excel, la inteligencia artificial y el simulador de cuota «no
// existen», y las tres existen desde hace meses. Leerlo me llevó a decirle al
// dueño que el bot no podía venderlas, que era falso — el bot vivo sí puede.
//
// Solo lo alcanza `lib/bot/test-multiagente.js`, un guion suelto que no llama
// nadie. Se conserva porque tres pruebas leen su vecino `contexto.js`.
//
// Enfoque original: whitelist estricta. Solo menciona lo que EXISTE.

import { DATOS_SISTEMA, PLANES, EXTRAS, FUNCIONES_SISTEMA } from './contexto.js'
...
- "Lo voy a pensar" -> NO ofrezcas video (los que hay son de antes del rediseño): "Puede probarlo gratis y verlo usted mismo, sin tarjeta."
...
(Nota para quien lea el codigo, no para el modelo: el bloque de VIDEOS se quito
el 16 ago 2026. Interpolaba una variable VIDEOS que no existe en ningun sitio y
habria reventado al construir el prompt.)
