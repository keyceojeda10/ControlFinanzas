...
/* ⚠ LA EMPRESA, LOS ENLACES Y EL SOPORTE SALEN DE LA KB (BOT v3 · sprint 5):
   los dos bots leen lo mismo, y corregir un dato es corregirlo una vez. */
import { EMPRESA } from '@/lib/bot-v2/kb'

const LINK_REGISTRO = EMPRESA.linkRegistro
const LINK_PAGO     = EMPRESA.linkPago
...
const SOPORTE       = EMPRESA.telefonoSoporte
const HORARIO       = EMPRESA.horarioSoporteLargo
