...
export function mensajeBienvenida(nombre) {
  ...
  return `${saludo}su cuenta ya quedó abierta.

Un consejo, que es donde se atasca casi todo el mundo: no se siente a escribir su cartera cliente por cliente, porque la deja a medias.

Entre a «Pasar mi cuaderno» y tómele foto a las hojas. De ahí salen los nombres y los montos solos, hasta 30 fotos de una vez.`
}
...
En el menú entra a «Pasar mi cuaderno» y le toma foto a las hojas. Derechas y con buena luz, que se lean los números.

Le salen los nombres y los montos en una lista. Usted revisa, corrige lo que esté mal y guarda.

Sirve la cartulina de un cliente y también la hoja con la lista de todos. Si algo no le cuadra, me escribe por aquí.`,
    avisar: false,
  },
  cartera_mano: {
    texto: `Sin problema. En Clientes, con el botón de más (+) los va metiendo uno por uno.

Eso sí: si pasa de veinte o treinta, la foto del cuaderno le ahorra la noche entera. Ahí sigue cuando la quiera.`,
    avisar: false,
  },
  cartera_ayuda: {
