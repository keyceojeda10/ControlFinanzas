  ...
  const estrategiaPorIntento = {
    1: linkYaEnviado
      ...
      : (leadRespondio
        ...
        : 'No ha respondido. Menciona UNA función que resuelva algo: "el sistema calcula la mora automática" o "cada cobrador cierra caja".'),
    2: 'Menciona UNA función real que NO hayas dicho antes. Ejemplos: "calcula la mora automática", "funciona sin internet", "ve las ganancias del día en segundos".',
    3: videollamadaOfrecida
      ? 'Ya ofreciste videollamada. Menciona UNA función real nueva.'
      : 'Ofrece videollamada: "Si quiere, le agendamos una videollamada de 15 min para mostrarle todo en vivo. ¿Le parece?"',
    4: 'Último mensaje de valor. UNA función real que no hayas dicho. 2 líneas máx.',
    5: 'Cierre: "Quedo atenta si en algún momento lo necesita." Sin presión, sin link.',
  }
