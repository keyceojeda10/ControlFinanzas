...
export async function responder(lead, historial, entrante) {
  ...
  // Claude principal, DeepSeek fallback
  if (anthropic) {
    try {
      ...
      console.warn('[Bot Agent] Claude no devolvio respuesta estructurada, intentando DeepSeek...')
    } catch (claudeError) {
      console.warn('[Bot Agent] Claude fallo, intentando DeepSeek:', claudeError.message)
    }
  }
  ...
  try {
    ...
    console.warn('[Bot Agent] DeepSeek no devolvio respuesta estructurada.')
  } catch (dsError) {
    console.warn('[Bot Agent] DeepSeek fallo:', dsError.message)
  }
...
Responde con la herramienta seguimiento_lead.`
  ...
  if (anthropic) {
    try {
      ...
      console.warn('[Bot Agent] Claude no devolvio seguimiento estructurado, intentando DeepSeek...')
    } catch (claudeError) {
      console.warn('[Bot Agent] Claude fallo (seguimiento), intentando DeepSeek:', claudeError.message)
    }
  }
  ...
  try {
    ...
    console.warn('[Bot Agent] DeepSeek no devolvio seguimiento estructurado.')
  } catch (dsError) {
    console.warn('[Bot Agent] DeepSeek fallo (seguimiento):', dsError.message)
  }
