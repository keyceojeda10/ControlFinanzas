...
export async function generarSeguimiento(lead, historial, numeroIntento = 1) {
  ...
  const estrategiaPorIntento = {
    ...
    3: 'Ofrece VIDEOLLAMADA o soporte humano: "Si le queda mas facil, puede escribirle a nuestro equipo al 301 199 3001 o agendamos una videollamada de 15 min para mostrarle todo en vivo. Que dia le queda bien?"',
