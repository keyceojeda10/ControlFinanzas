...
export async function responder(lead, historial, entrante) {
  ...
  const PAGO_KEYWORDS = /como pago|quiero pagar|donde pago|activar plan|activar mi plan|se me (?:acabo|vencio|termino)|vencio (?:mi |la )prueba|acabo (?:mi |la )prueba|quiero seguir|quiero el plan|renovar|como contrato|comprar el plan|adquirir/i
