...
test('prompt tiene identidad Daniela', () => {
  if (!PROMPT_VENTAS.includes('Daniela')) throw new Error('falta nombre Daniela')
})
...
test('prompt tiene seccion de soporte (despachar rapido)', () => {
  if (!PROMPT_VENTAS.includes('PROBLEMAS TECNICOS O SOPORTE')) throw new Error('falta seccion soporte')
})
