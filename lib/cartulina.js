...
- LA TABLA DE ABONOS (FECHA · ABONO · SALDO) es la mitad de la cartulina:
  ...
  - cuotasPagadas = renglones escritos; montoPagadoHasta = suma de los abonos
  - saldoPendiente = el ÚLTIMO saldo de la columna, el de más abajo
  - si el saldo BAJA y de golpe SUBE, ahí empezó OTRO préstamo: informa el
    ÚLTIMO, que es el que sigue vivo, y menciona el anterior en notas
