    ...
    <div className="space-y-4">
      ...
      {loading && (
        <div className="flex items-center justify-center h-32">
          <svg className="animate-spin w-5 h-5" style={{ color: 'var(--cf-gold)' }} fill="none" viewBox="0 0 24 24">
      ...
      {!loading && error && (
        <p className="text-sm text-center py-8" style={{ color: 'var(--cf-red-dark)' }}>{error}</p>
      )}
