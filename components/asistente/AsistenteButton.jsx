...
const AsistenteButton = forwardRef(function AsistenteButton({ onOpenChange }, ref) {
  ...
  return (
    <>
      {/* Desktop-only floating button — mobile accesses via FAB menu */}
      <button
        onClick={() => setOpen(v => !v)}
      ...
      >
        ...
        <span className="text-sm font-semibold">Lucas IA</span>
      </button>
...
export default AsistenteButton
