...
const PALETTES_LIGHT = {
  ok: {
    ...
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.35) 38%, rgba(255,255,255,0.55) 50%, rgba(255,255,255,0.35) 62%, transparent 80%)',
  },
  nuevo: {
    ...
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.38) 38%, rgba(255,255,255,0.58) 50%, rgba(255,255,255,0.38) 62%, transparent 80%)',
  },
  hot: {
    ...
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.32) 38%, rgba(255,255,255,0.50) 50%, rgba(255,255,255,0.32) 62%, transparent 80%)',
  },
  crit: {
    ...
    waves: 'rgba(255,255,255,0.5)',
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,255,255,0.30) 38%, rgba(255,255,255,0.48) 50%, rgba(255,255,255,0.30) 62%, transparent 80%)',
  },
  done: {
...
const PALETTES_DARK = {
  ok: {
    ...
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,220,100,0.15) 38%, rgba(255,240,160,0.28) 50%, rgba(255,220,100,0.15) 62%, transparent 80%)',
  },
  nuevo: {
    ...
    shadow: '0 10px 24px rgba(0, 0, 0, 0.35)',
    waves: 'rgba(255,255,255,0.06)',
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(80,255,140,0.14) 38%, rgba(140,255,200,0.26) 50%, rgba(80,255,140,0.14) 62%, transparent 80%)',
  },
  hot: {
    ...
    shadow: '0 10px 24px rgba(0, 0, 0, 0.35)',
    waves: 'rgba(255,255,255,0.06)',
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,160,60,0.15) 38%, rgba(255,200,120,0.28) 50%, rgba(255,160,60,0.15) 62%, transparent 80%)',
  },
  crit: {
    ...
    shadow: '0 10px 24px rgba(0, 0, 0, 0.35)',
    waves: 'rgba(255,255,255,0.06)',
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(255,120,140,0.14) 38%, rgba(255,170,185,0.26) 50%, rgba(255,120,140,0.14) 62%, transparent 80%)',
  },
  done: {
    ...
    shadow: '0 10px 24px rgba(0, 0, 0, 0.35)',
    waves: 'rgba(255,255,255,0.06)',
    sheen: 'linear-gradient(105deg, transparent 20%, rgba(80,220,130,0.14) 38%, rgba(120,255,180,0.26) 50%, rgba(80,220,130,0.14) 62%, transparent 80%)',
  },
  off: {
