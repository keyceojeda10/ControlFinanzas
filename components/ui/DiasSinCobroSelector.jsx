          ...
          return (
            <button
              ...
              className={[
                ...
                activo
                  ? 'bg-[rgba(245,158,11,0.15)] border-[var(--cf-gold-dark)] text-[var(--cf-gold-dark)]'
                  : 'bg-transparent border-[var(--cf-border)] text-[var(--cf-ink-3)] hover:bg-[var(--cf-surface)] hover:text-[var(--cf-ink)]',
              ].join(' ')}
            >
              {label}
            </button>
