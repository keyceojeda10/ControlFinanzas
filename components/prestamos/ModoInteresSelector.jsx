...
const MODOS = [
  {
    ...
    label: 'Cuota fija',
    tag: 'Recomendado',
    desc: 'La cuota es la misma todos los dias. Capital + interés repartidos en partes iguales. Es el método más usado.',
  },
  {
    key: 'unico',
    label: 'Interés de una sola vez',
    tag: 'De una vez',
    desc: 'El cliente paga todo el interés al inicio (o al final). Las cuotas solo devuelven el capital. Ideal para préstamos cortos.',
  },
  {
    key: 'solo_interes',
    label: 'Solo interés, capital al final',
    tag: 'Globo',
    desc: 'El cliente paga solo el interés cada periodo. El capital completo se devuelve al final en una sola cuota grande. Ideal para clientes que manejan flujo de caja.',
  },
  {
    key: 'saldo',
    label: 'Interés sobre lo que falta',
    tag: 'Como los bancos',
    desc: 'El interés se calcula sobre el saldo pendiente: a medida que paga capital, el interés baja. La cuota empieza alta y va bajando.',
  },
  {
    key: 'manual',
