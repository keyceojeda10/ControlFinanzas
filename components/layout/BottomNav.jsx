...
const MORE_ITEMS_OWNER = [
  ...
  { label: 'Analíticas', href: '/dashboard/analiticas', icon: 'M2.25 18L9 11.25l4.306 4.306a11.95 11.95 0 015.814-5.518l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941' },
