...
export default function SinRutaBanner() {
  ...
  return (
    <div className="mx-4 lg:mx-6 mt-4 flex items-center gap-3 bg-[rgba(245,158,11,0.1)] border border-[rgba(245,158,11,0.3)] rounded-[14px] px-4 py-3">
      ...
      <div>
        <p className="text-sm font-semibold text-[#f59e0b]">No tienes una ruta asignada</p>
        <p className="text-xs text-[#888888]">Contacta al administrador para que te asigne una ruta de cobro.</p>
      </div>
    </div>
  )
}
