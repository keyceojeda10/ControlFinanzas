  ...
  return (
    <>
      ...
      <header
        ...
        style={{
          background: 'color-mix(in srgb, var(--cf-surface) 85%, transparent)',
          ...
          >
            <div className="relative">
              ...
              <span
                ...
                style={{ background: 'var(--cf-green-dark)', border: '2px solid var(--cf-surface)' }}
              />
            </div>
          ...
          {userOpen && (
            ...
            >
              <div className="px-4 py-3.5">
                <p className="text-[13px] font-semibold truncate" style={{ color: 'var(--cf-ink)' }}>{nombre}</p>
                <p className="text-[11px] truncate mt-0.5" style={{ color: 'var(--cf-ink-3)' }}>{session?.user?.email}</p>
              </div>
