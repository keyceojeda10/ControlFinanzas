...
async function main() {
  ...
  console.log('  Superadmin : admin@control-finanzas.com / Admin2026*')
  console.log('  Owner      : owner@test.com / 123456')
  console.log('  Cobrador 1 : cobrador1@test.com / 123456')
  console.log('  Cobrador 2 : cobrador2@test.com / 123456')
  console.log('\nORGANIZACION:')
  console.log('  Prestamos Garcia (plan standard)')
  console.log('\nRUTAS:')
  console.log('  Ruta Norte -> Juan Perez')
  console.log('  Ruta Sur   -> Pedro Lopez')
  console.log('\nCLIENTES: 10 (5 por ruta)')
  console.log('\nPRESTAMOS:')
  console.log('  1. Maria Gonzalez  | $200.000 | 30 dias | 10/30 pagos')
  console.log('  2. Ana Martinez    | $500.000 | 60 dias |  5/60 pagos')
  console.log('  3. Isabel Vargas   | $300.000 | 20 dias | 18/20 pagos')
  console.log('\nSUSCRIPCION: standard activa hasta 2026-03-01')
  console.log('----------------------------------------')
}
