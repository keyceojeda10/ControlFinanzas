...
export async function GET() {
  ...
  const instrucciones = [
    ...
    ['tipo', 'No', '"préstamo" (dinero) o "mercancía" (artículo). Default: préstamo'],
    ['montoPrestado', 'No*', 'Monto original del préstamo / valor del artículo'],
    ['tasaInteres', 'No*', 'Tasa de interés mensual (ej: 20 = 20%). Mercancía: 0'],
    ['diasPlazo', 'No*', 'Plazo en días del préstamo'],
    ['frecuencia', 'No', 'diario, semanal, quincenal o mensual (default: diario)'],
    ['fechaInicio', 'No*', 'Fecha de inicio del préstamo (DD/MM/YYYY)'],
    ['abonadoHasta', 'No', 'Total ya pagado por el cliente (préstamos en curso)'],
    [''],
    ['NOTAS IMPORTANTES:'],
    ['- Las columnas de préstamo son opcionales como grupo.'],
    ['  Si llenas montoPrestado, debes llenar tasaInteres, diasPlazo y fechaInicio.'],
    ['- Un cliente puede tener MULTIPLES préstamos: repite la cédula en varias filas.'],
    ['  Ejemplo: Juan Pérez (fila 1 y 2) tiene un préstamo de dinero y uno de mercancía.'],
    ['- Si no llenas datos de préstamo, se crea solo el cliente.'],
    ['  Ejemplo: Pedro García (fila 4) solo se crea como cliente, sin préstamo.'],
    ['- "abonadoHasta" es para préstamos que ya llevan tiempo (migración).'],
