...
export async function PATCH(req) {
  ...
  const { nombre, telefono, ciudad, diasSinCobro, capitalEsEfectivo, modoAbreviado, ocultarSaldoWA, tasaMoratorio, diasGraciaMoratorio, requiereAprobacionPrestamos, ocultarCapitalCobradores } = await req.json()
  ...
  const org = await prisma.organization.update({
    ...
    data: {
      ...
      ...(ocultarCapitalCobradores !== undefined && { ocultarCapitalCobradores: !!ocultarCapitalCobradores }),
    },
    select: { id: true, nombre: true, plan: true, telefono: true, ciudad: true, diasSinCobro: true, country: true, timezone: true, capitalEsEfectivo: true, modoAbreviado: true, ocultarSaldoWA: true, tasaMoratorio: true, diasGraciaMoratorio: true, requiereAprobacionPrestamos: true, ocultarCapitalCobradores: true },
  })
