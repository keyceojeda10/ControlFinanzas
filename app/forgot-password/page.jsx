    ...
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-[var(--color-bg-base)] px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-[24px] p-8">
            ...
            <h2 className="text-lg font-bold text-[var(--color-text-primary)] mb-2">Revisa tu correo</h2>
            <p className="text-sm text-[var(--color-text-muted)] mb-4">
              Si existe una cuenta con <strong className="text-[var(--color-text-primary)]">{email}</strong>, recibirás un enlace para restablecer tu contraseña.
            </p>
            <p className="text-xs text-[var(--color-text-muted)]">
              El enlace expira en 1 hora. Revisa también tu carpeta de spam.
            </p>
          </div>
          <Link href="/login" className="inline-block mt-6 text-sm text-[var(--color-accent)] hover:underline font-medium">
            Volver al login
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-dvh flex flex-col items-center justify-center bg-[var(--color-bg-base)] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Image src="/logo-icon.svg" alt="Control Finanzas" width={56} height={56} className="mx-auto mb-5" priority />
          <h1 className="text-2xl font-bold text-[var(--color-text-primary)] tracking-tight">Recuperar contraseña</h1>
          <p className="text-sm text-[var(--color-text-muted)] mt-1">Te enviaremos un enlace a tu correo</p>
        </div>
