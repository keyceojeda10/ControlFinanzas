          ...
          <KpiGroup title="Tu cartera" icon={Icons.cartera}>
            <div className="grid grid-cols-2 gap-3">
              <KpiCard
                ...
                sub={`Capital prestado: ${formatMoney(data.prestamos.capitalPrestado)}`}
                color="var(--color-warning)"
                info={{
                  ...
                  ejemplo: `Tus clientes te deben ${formatMoney(data.prestamos.saldoPorCobrar ?? data.prestamos.carteraActiva)}. La promesa total cuando todos terminen de pagar es ${formatMoney(data.prestamos.carteraActiva)}, y el capital que pusiste en la calle es ${formatMoney(data.prestamos.capitalPrestado)}.`,
                  ...
                  tip: 'OJO: este número incluye los intereses, no es tu capital. Tu capital prestado lo ves justo debajo del monto.',
                }}
