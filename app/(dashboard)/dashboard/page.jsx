        ...
        <div className="flex gap-2">
          {puedeCrearPrestamos && (
            <Link
              ...
              className="flex-1 relative overflow-hidden rounded-[14px] px-3 py-3 flex items-center gap-2.5 transition-all active:scale-[0.97]"
              style={{
            ...
            >
              <div className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: 'color-mix(in srgb, #22c55e 15%, transparent)' }}>
                <svg className="w-4.5 h-4.5" fill="none" stroke="#22c55e" strokeWidth={2.2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
              </div>
              <span className="text-[11px] font-bold leading-tight whitespace-nowrap" style={{ color: '#22c55e' }}>Prestamo</span>
            </Link>
          )}
          {puedeCrearClientes && (
            <Link
            ...
            >
              <div className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: 'color-mix(in srgb, #f5c518 15%, transparent)' }}>
                <svg className="w-4.5 h-4.5" fill="none" stroke="#f5c518" strokeWidth={2.2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" /></svg>
              </div>
              <span className="text-[11px] font-bold leading-tight whitespace-nowrap" style={{ color: '#f5c518' }}>Cliente</span>
            </Link>
          )}
          <Link
            href="/caja"
          ...
          >
            <div className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0" style={{ background: 'color-mix(in srgb, #06b6d4 15%, transparent)' }}>
              <svg className="w-4.5 h-4.5" fill="none" stroke="#06b6d4" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 00-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 01-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 003 15h-.75M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            </div>
            <span className="text-[11px] font-bold leading-tight whitespace-nowrap" style={{ color: '#06b6d4' }}>Caja</span>
          </Link>
        </div>
      )}
