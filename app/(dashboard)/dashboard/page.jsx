          ...
          <KpiGroup title="Tu cartera" icon={Icons.cartera}>
            <div className="grid grid-cols-2 gap-3">
              <KpiCard
                ...
                sub={`Capital en la calle: ${formatMoney(data.prestamos.capitalEnCalle)}`}
                color="var(--cf-gold-dark)"
                info={{
                  ...
                  tip: 'OJO: este número incluye los intereses, no es tu capital. Tu plata pura la ves justo debajo del monto, en «Capital en la calle».',
                }}
