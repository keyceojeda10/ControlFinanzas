          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-base font-bold" style={{ color: 'var(--cf-ink)' }}>Crear manual</h3>
          ...
          {ocrLoading ? (
            <div className="w-full text-left rounded-2xl p-4"
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-semibold" style={{ color: 'var(--cf-ink)' }}>Leyendo foto...</h3>
                  <p className="text-xs mt-0.5" style={{ color: 'var(--cf-ink-3)' }}>Extrayendo datos...</p>
                </div>
              </div>
            </div>
          ) : (
            <div className="rounded-2xl overflow-hidden"
              ...
              <div className="px-4 pt-3.5 pb-2">
                <h3 className="text-sm font-semibold" style={{ color: 'var(--cf-ink)' }}>Desde foto</h3>
                <p className="text-xs mt-0.5" style={{ color: 'var(--cf-ink-3)' }}>La IA lee la cartulina o libreta</p>
              </div>
              <div className="grid grid-cols-2 gap-0" style={{ borderTop: '1px solid var(--cf-border)' }}>
                <button
                  type="button"
                  onClick={() => fotoInputRef.current?.click()}
                  className="flex items-center justify-center gap-2 py-3 text-sm font-medium transition-all active:scale-[0.97]"
                  style={{ color: 'var(--cf-ink-2)', borderRight: '1px solid var(--cf-border)' }}
                >
        ...
        {ocrAdvertencias.length > 0 && (
          <div className="mt-3 space-y-1">
            {ocrAdvertencias.map((a, i) => (
              <p key={i} className="text-[11px]" style={{ color: 'var(--cf-gold-dark)' }}>{a}</p>
            ))}
          </div>
        )}
      </div>
