  ...
  return (
    <div className="space-y-5">
      ...
      <Modal open={avatarPickerOpen} onClose={() => setAvatarPickerOpen(false)} title="Elige tu avatar" size="lg">
        <div className="space-y-5 max-h-[70dvh] overflow-y-auto pr-1" style={{ scrollbarWidth: 'thin' }}>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={inputClass}
            />
            {/* ⚠ ANTES DECÍA lo mismo pero era MENTIRA: el cálculo subía este
                número según la frecuencia —15 días en mensual— sin avisar.
                Rincón puso CERO, se le aplicaban QUINCE, y el moratorio no le
                salía nunca: «aunque tiene intereses moratorio, no se puede
                aplicar». El suelo oculto ya no existe; ahora vale lo que se
                escriba aquí. */}
            <p className="text-[10px] text-[var(--cf-ink-3)] leading-snug px-0.5">
              Días que deben pasar en mora antes de calcular el interés. Vale igual para todas
