...
export default function CapitalPage() {
  ...
  return (
    <div className="max-w-3xl lg:max-w-6xl mx-auto p-4">
      <div className="mb-5">
        <h1 className="text-[25px] font-semibold text-[var(--cf-ink)]">Capital</h1>
        <p className="text-sm text-[var(--cf-ink-3)] mt-0.5">Tu fondo de préstamos — dinero disponible para prestar</p>
      </div>
      {bannerVisible && (
