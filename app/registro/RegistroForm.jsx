...
function CanalSelector({ canal, onChange, theme }) {
  return (
    <div className="grid grid-cols-2 gap-3 mb-6">
      ...
      >
        ...
        <svg className="w-7 h-7" style={{ color: canal === 'whatsapp' ? '#25d366' : theme.textMuted }} fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          ...
          <p className="text-[11px]" style={{ color: theme.textSecondary }}>Recomendado</p>
        </div>
      </button>
      ...
      >
        ...
        <svg className="w-7 h-7" style={{ color: canal === 'email' ? 'var(--color-accent)' : theme.textMuted }} fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        ...
        <div className="text-center">
          ...
          <p className="text-[11px]" style={{ color: theme.textSecondary }}>Alternativo</p>
        </div>
      </button>
    </div>
  )
          ...
          {step === 2 && (
            <div>
              ...
              <div className="mb-2">
                ...
                <CanalSelector canal={verificarPor} onChange={(c) => { setVerificarPor(c); setError('') }} theme={t} />
              </div>
