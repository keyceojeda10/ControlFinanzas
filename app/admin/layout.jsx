...
const nav = [
  ...
  {
    /* La lista que sustituye a cinco. Medido: `organizaciones`, `suscripciones`,
       `activacion`, `retencion` y `crm` consultaban la MISMA tabla para
       contestar variantes de la misma pregunta. Las viejas siguen accesibles
       hasta que el perfil absorba sus acciones — quitarlas antes seria perder
       funciones sin avisar. */
    href: '/admin/usuarios',
    label: 'Usuarios',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
