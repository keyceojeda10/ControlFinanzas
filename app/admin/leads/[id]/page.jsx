...
function LeadDetailSkeleton() {
  return (
    <div className="space-y-5 animate-pulse">
      {/* Back link */}
      <div className="h-4 w-28 bg-[var(--cf-surface)] rounded" />

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Panel izquierdo */}
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-[var(--cf-surface)] border border-[var(--cf-border)] rounded-[16px] p-5 space-y-4">
            <div className="h-6 w-40 bg-[var(--cf-fill)] rounded" />
            <div className="space-y-2">
              <div className="h-3 w-32 bg-[var(--cf-fill)] rounded" />
              <div className="h-3 w-24 bg-[var(--cf-fill)] rounded" />
              <div className="h-3 w-36 bg-[var(--cf-fill)] rounded" />
            </div>
          </div>
          <div className="bg-[var(--cf-surface)] border border-[var(--cf-border)] rounded-[16px] p-5 space-y-3">
            <div className="h-9 w-full bg-[var(--cf-fill)] rounded-[10px]" />
            <div className="h-20 w-full bg-[var(--cf-fill)] rounded-[10px]" />
            <div className="h-10 w-full bg-[var(--cf-fill)] rounded-[12px]" />
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-[var(--cf-surface)] border border-[var(--cf-border)] rounded-[16px] p-5 space-y-3">
              <div className="flex items-center justify-between">
                <div className="h-5 w-24 bg-[var(--cf-fill)] rounded-full" />
                <div className="h-5 w-16 bg-[var(--cf-fill)] rounded-full" />
              </div>
              <div className="h-3 w-full bg-[var(--cf-fill)] rounded" />
              <div className="h-3 w-4/5 bg-[var(--cf-fill)] rounded" />
              <div className="h-3 w-3/5 bg-[var(--cf-fill)] rounded" />
              <div className="flex gap-2 pt-1">
                <div className="h-12 flex-1 bg-[var(--cf-fill)] rounded-[12px]" />
                <div className="h-12 w-24 bg-[var(--cf-fill)] rounded-[12px]" />
              </div>
            </div>
          ))}
        </div>
...
function MensajeCard({ msg, lead, enviados, onToggleEnviado, onWhatsAppClick }) {
  ...
  const catConfig = CATEGORIAS[msg.category] ?? { label: msg.category, color: 'var(--cf-ink-3)' }
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex flex-col gap-1.5 min-w-0 flex-1">
            ...
            <p className="text-sm font-semibold text-[var(--cf-ink)] leading-tight">
              {msg.label}
            </p>
          </div>
          ...
          <button
            ...
            className={[
              ...
              enviado
                ? 'bg-[rgba(34,197,94,0.15)] border-[rgba(34,197,94,0.4)] text-[var(--cf-green-dark)]'
                : 'bg-transparent border-[var(--cf-border)] text-[var(--cf-ink-3)] hover:border-[var(--cf-border-strong)] hover:text-[var(--cf-ink-3)]',
            ].join(' ')}
        ...
        {/* Condición */}
        <p className="text-[11px] text-[var(--cf-ink-3)] leading-relaxed">
          {msg.condition}
        </p>
        ...
        {msg.image && (
          <div className="space-y-2">
            <div className="relative rounded-[10px] overflow-hidden border border-[var(--cf-border)]">
              <Image
                src={msg.image}
              ...
              <div className="absolute top-2 right-2 flex gap-1.5">
                <a
                  href={msg.image}
                  download
                  className="flex items-center gap-1 px-2.5 py-1.5 rounded-[8px] bg-black/70 backdrop-blur-sm border border-[#333333] text-[10px] text-[var(--cf-ink)] font-medium hover:bg-black/90 transition-all"
                >
            ...
            <p className="text-[10px] text-[var(--cf-gold-dark)] font-medium">
        ...
        <div
          className={[
            ...
            enviado
              ...
              : 'bg-[var(--cf-card)] border-[var(--cf-border)]',
          ].join(' ')}
        >
        ...
        <div className="flex gap-2 pt-1">
          ...
          {waLink ? (
            <a
              ...
              className="
                ...
                text-[var(--cf-green-dark)] text-sm font-bold
          ...
          <button
            ...
            className={[
              ...
              copiado
                ? 'bg-[rgba(34,197,94,0.1)] border-[rgba(34,197,94,0.3)] text-[var(--cf-green-dark)]'
                : 'bg-[var(--cf-card)] border-[var(--cf-border)] text-[var(--cf-ink-3)] hover:text-[var(--cf-ink)] hover:border-[var(--cf-border-strong)]',
            ].join(' ')}
          >
            {copiado ? (
              <>
...
function InfoRow({ label, children }) {
  return (
    <div className="flex items-start justify-between gap-2 py-2.5 border-b border-[var(--cf-border)] last:border-0">
      <span className="text-[10px] text-[var(--cf-ink-3)] uppercase tracking-wide shrink-0 mt-0.5 font-medium">
        {label}
      </span>
...
export default function LeadDetallePage({ params }) {
  ...
  if (error) return (
    <div className="max-w-6xl mx-auto px-4 py-4 pb-24 sm:pb-8">
      <Link
        href="/admin/leads"
        className="inline-flex items-center gap-1.5 text-sm text-[var(--cf-ink-3)] hover:text-[var(--cf-ink)] mb-5 transition-colors"
      >
      ...
      <div className="bg-[rgba(239,68,68,0.08)] border border-[rgba(239,68,68,0.2)] rounded-[12px] px-4 py-4 space-y-2">
        <p className="text-sm text-[var(--cf-red-dark)] font-medium">No se pudo cargar el lead</p>
        <p className="text-xs text-[var(--cf-red-dark)]/70">{error}</p>
        <button
          onClick={fetchLead}
          className="text-xs text-[var(--cf-red-dark)]/70 underline underline-offset-2 hover:text-[var(--cf-red-dark)] transition-colors"
        >
          Reintentar
        </button>
      </div>
    ...
    <div className="max-w-6xl mx-auto px-4 py-4 sm:py-6 pb-24 sm:pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          {/* Card de información */}
          <div className="bg-[var(--cf-surface)] border border-[var(--cf-border)] rounded-[16px] p-5">

            {/* Nombre + estado */}
            <div className="flex items-start justify-between gap-3 mb-4">
              <div className="min-w-0 flex-1">
                <h1 className="text-[25px] font-semibold text-[var(--cf-ink)] leading-tight break-words">
                  {lead.nombre}
                </h1>
              </div>
            ...
            <div className="space-y-0">
              ...
              {lead.telefono && (
                <InfoRow label="Teléfono">
                  <a
                    ...
                    className="text-sm text-[var(--cf-gold)] font-semibold hover:text-[#f0b800] transition-colors"
                  >
                    {lead.telefono}
                  </a>
                </InfoRow>
              ...
              {lead.adId && (
                <InfoRow label="Anuncio ID">
                  <span className="text-[11px] text-[var(--cf-ink-3)] font-mono break-all">{lead.adId}</span>
                </InfoRow>
              )}
              ...
              <InfoRow label="Registrado">
                <div className="text-right">
                  <p className="text-xs text-[var(--cf-ink-3)]">{haceTiempo(lead.createdAt)}</p>
                  <p className="text-[10px] text-[var(--cf-ink-3)] mt-0.5">{formatFechaLarga(lead.createdAt)}</p>
                </div>
              </InfoRow>
              ...
              <InfoRow label="Org vinculada">
                {lead.organization?.nombre ? (
                  <span className="text-xs text-[var(--cf-green-dark)] font-medium">{lead.organization.nombre}</span>
                ) : (
                  <span className="text-xs text-[var(--cf-ink-3)]">Sin registrar</span>
                )}
              </InfoRow>
          ...
          <div className="bg-[var(--cf-surface)] border border-[var(--cf-border)] rounded-[16px] p-5 space-y-4">
            <p className="text-[10px] text-[var(--cf-ink-3)] uppercase tracking-wide font-semibold">
              Estado y notas
            </p>

            {/* Select de estado */}
            <div>
              <label className="text-[10px] text-[var(--cf-ink-3)] uppercase tracking-wide block mb-1.5">
                Estado
              </label>
              <select
                value={estado}
                onChange={(e) => setEstado(e.target.value)}
                className="w-full h-10 px-3 rounded-[10px] border border-[var(--cf-border)] bg-[var(--cf-card)] text-sm text-[var(--cf-ink)] focus:outline-none focus:border-[rgba(245,197,24,0.4)] transition-colors appearance-none cursor-pointer"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 rounded-[10px] border border-[var(--cf-border)] bg-[var(--cf-card)] text-sm text-[var(--cf-ink)] placeholder-[#444444] focus:outline-none focus:border-[rgba(245,197,24,0.4)] resize-none transition-colors"
              />
            </div>
              ...
              {saveMsg && (
                <span
                  className={[
                    ...
                    saveMsg === 'Guardado' ? 'text-[var(--cf-green-dark)]' : 'text-[var(--cf-red-dark)]',
                  ].join(' ')}
                >
                ...
                {MENSAJES.map((msg) => (
                  <div
                    ...
                    className={[
                      ...
                      enviados.includes(msg.id) ? 'bg-[var(--cf-green-dark)]' : 'bg-[var(--cf-fill)]',
                    ].join(' ')}
                    title={msg.label}
                  />
                ))}
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-base font-bold text-[var(--cf-ink)]">
                Mensajes WhatsApp
              </h2>
            ...
            <div className="flex items-center gap-2">
              <WhatsAppIcon className="w-5 h-5 text-[var(--cf-green-dark)]" />
            ...
            return (
              <div key={cat} className="mb-6">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  {enviadosEnCat > 0 && (
                    <span className="text-[10px] text-[var(--cf-green-dark)] font-medium">
